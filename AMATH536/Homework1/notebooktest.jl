...
# ╔═╡ a9cdf248-bb08-11ec-3dc8-e783d0b4ed28
using Random, Plots, Distributions, LaTeXStrings, Printf

# ╔═╡ e2e45c5f-01bf-4540-83cb-5d8187399cfe
...
# ╔═╡ 457bdb3e-9ebc-4566-a8a2-59a18e05690f
xlabel!(latexstring(@sprintf("\\mathrm{time}")))

# ╔═╡ c0c54296-6ad4-485e-88e6-6aa32c09a0e5
ylabel!(latexstring(@sprintf("\\mathrm{Number~of~individuals}")))

# ╔═╡ fc42c11e-1a40-47c1-a56f-a8820dcbe308
for i=1:10
    results=simul(a, t, λ, μ, i)
...
# ╔═╡ 05d85523-4729-439e-a672-b2e5135b2db9
display(p2)

# ╔═╡ 63986b4e-4e80-428f-bec5-a379a6655330
#part e
...
# ╔═╡ 2e6729a9-47ce-48c7-ac6c-61d46719cdad
...
# ╔═╡ 838be530-d1a7-4202-8ef1-90eea459214b
#part f1
#λ, μ, a = 1., 1., 10

# ╔═╡ b10cc760-d137-4992-8a12-f0090d9ebc87
tvec = 0:10:100

# ╔═╡ 49a53b9c-ddda-4e93-9a47-59947107eec1
avgvec = zeros(size(tvec))

# ╔═╡ f5b20cd4-d275-4fef-9961-f5f7086e26ae
numruns = 20000

# ╔═╡ 8c2a8918-1ac1-4c28-9d8e-04aaa1d892e6
for (i,t) in enumerate(tvec)
    avgvec[i] = simulation(t,numruns, a, λ, μ)
end

# ╔═╡ 91703c1a-e120-4e44-92db-64ec9806e895
p3 = plot(tvec,avgvec, seriestype = :scatter)

# ╔═╡ 78f3a76b-fc01-4d8d-a5e2-85bc0ddc0d6b
λ, μ, a, t = 1., 1., 10, 100.

# ╔═╡ d86fec3b-b6d7-4898-8a82-f4b6cb7bb8e6
begin
	#part d
	λ, μ, a, t = 1.1, 1., 10, 50.
end
